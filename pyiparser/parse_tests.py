...
test_dict = {
    ...
    # @property
    # def real(self) -> int: ...
    ('int', r'def real(self) -> int: ...'):
        r'self:T?1 /\ return:T?r ^ (T?1:int /\ T?r:int)',
    # @property
    # def imag(self) -> Literal[0]: ...
    ('int', r'def imag(self) -> Literal[0]: ...'):
        r'self:T?1 /\ return:T?r ^ (T?1:int /\ T?r:int)',
    # @property
    # def numerator(self) -> int: ...
    ('int', r'def numerator(self) -> int: ...'):
        r'self:T?1 /\ return:T?r ^ (T?1:int /\ T?r:int)',
    # @property
    ...
    ('int', r'def __add__(self, __value: int) -> int: ...'):
    ...
    ('int', r'def __truediv__(self, __value: int) -> float: ...'):
    ...
    ('int', r'def __divmod__(self, __value: int) -> tuple[int, int]: ...'):
    ...
    ('int', r'def __pow__(self, __x: Literal[0]) -> Literal[1]: ...'):
        r'self:T?1 /\ __x:T?2 /\ return:T?r ^ (T?1:int /\ T?2:int /\ T?r:int)',
    # @overload
    # def __pow__(self, __value: Literal[0], __mod: None) -> Literal[1]: ...
    ('int', r'def __pow__(self, __value: Literal[0], __mod: None) -> Literal[1]: ...'):
        r'self:T?1 /\ __value:T?2 /\ __mod:T?3 /\ return:T?r ^ '
        r'(T?1:int /\ T?2:int /\ T?3:NoneType /\ T?r:int)',
    # @overload
    # def __pow__(self, __value: _PositiveInteger, __mod: None = None) -> int: ...
    ('int', r'def __pow__(self, __value: _PositiveInteger, __mod: None = None) -> int: ...'):
        r'self:T?1 /\ __value:T?2 /\ __mod:T?3 /\ return:T?r ^ '
        r'(T?1:int /\ T?2:int /\ T?3:NoneType /\ T?r:int)',
    # @overload
    # def __pow__(self, __value: _NegativeInteger, __mod: None = None) -> float: ...
    ('int', r'def __pow__(self, __value: _NegativeInteger, __mod: None = None) -> float: ...'):
        r'self:T?1 /\ __value:T?2 /\ __mod:T?3 /\ return:T?r ^ '
        r'(T?1:int /\ T?2:int /\ T?3:NoneType /\ T?r:float)',
    ...
    ('int', r'def __pow__(self, __value: int, __mod: int) -> int: ...'):
        r'self:T?1 /\ __value:T?2 /\ __mod:T?3 /\ return:T?r ^ '
        r'(T?1:int /\ T?2:int /\ T?3:int /\ T?r:int)',
    ...
    ('int',r'def __float__(self) -> float: ...'):
        r'self:T?1 /\ return:T?r ^ (T?1:int /\ T?r:float)',
    # def __int__(self) -> int: ...
    # def __abs__(self) -> int: ...
    # def __hash__(self) -> int: ...
    # def __bool__(self) -> bool: ...
    ('int', r'def __bool__(self) -> bool: ...'):
