...
class TestScreenLogic(unittest.TestCase):
    ...
    def testScreenInputs(self):
        ...
        for testCase in screenTestCases:
            ...
            b = ('-ai' in args or '--all-input' in args)
            screenData = screenTestRunner.getRowsFromScreenRun(
                ...
                # allInput=b,
                testCase.get('input', 'gitDiff.txt'),
                charInputs,
                testCase.get('screenConfig', {}),
                False,
                testCase.get('pastScreen', None),
                testCase.get('pastScreens', None),
                testCase.get('validateFileExists', False),
                b,
                args
            )
    ...
    def compareLinesAndAttributesToExpected(self, testName, screenData):
        ...
        file = io.open(TestScreenLogic.getExpectedFile(testName))
