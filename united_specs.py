...
unitedspecs = {
    '__init__': {
        ...
        r'((self:memoryview < int > /\ obj:memoryview + bytes + bytearray) -> (return:NoneType))',
        r'((self:dict < str, T?2 > /\ __kw_kwargs:T?2) -> (return:NoneType))',
        r'((self:range < int > /\ __stop:SupportsIndex) -> (return:NoneType))',
        r'((self:bytearray /\ __ints:memoryview + SupportsIndex + Iterable < SupportsIndex > + bytes + bytearray) -> (return:NoneType))',
    ...
    '__add__': {
        ...
        r'((self:bytes /\ __value:memoryview + bytes + bytearray) -> (return:bytes))',
        r'((self:bytearray /\ __value:memoryview + bytes + bytearray) -> (return:bytearray))',
    ...
    '__lt__': {
        ...
        r'((self:bytearray /\ __value:memoryview + bytes + bytearray) -> (return:bool))',
    ...
    'count': {
        r'((self:bytes /\ __sub:SupportsIndex + memoryview + bytes + bytearray /\ __d___start:NoneType + SupportsIndex /\ __d___end:NoneType + SupportsIndex) -> (return:int))',
        ...
        r'((self:bytearray /\ __sub:SupportsIndex + memoryview + bytes + bytearray /\ __d___start:NoneType + SupportsIndex /\ __d___end:NoneType + SupportsIndex) -> (return:int))',
    ...
    'endswith': {
        r'((self:bytes /\ __suffix:tuple < memoryview + bytes + bytearray > + memoryview + bytes + bytearray /\ __d___start:NoneType + SupportsIndex /\ __d___end:NoneType + SupportsIndex) -> (return:bool))',
        r'((self:bytearray /\ __suffix:tuple < memoryview + bytes + bytearray > + memoryview + bytes + bytearray /\ __d___start:NoneType + SupportsIndex /\ __d___end:NoneType + SupportsIndex) -> (return:bool))',
        r'((self:str /\ __suffix:tuple < str > + str /\ __d___start:NoneType + SupportsIndex /\ __d___end:NoneType + SupportsIndex) -> (return:bool))',
    },
    'find': {
    ...
    'join': {
        r'((self:bytearray /\ __iterable_of_bytes:Iterable < bytearray + memoryview + bytes >) -> (return:bytearray))',
        r'((self:bytes /\ __iterable_of_bytes:Iterable < bytearray + memoryview + bytes >) -> (return:bytes))',
    ...
    'partition': {
        r'((self:bytearray /\ __sep:memoryview + bytes + bytearray) -> (return:tuple < bytearray >))',
        r'((self:bytes /\ __sep:memoryview + bytes + bytearray) -> (return:tuple < bytes >))',
        r'((self:str /\ __sep:str) -> (return:tuple < str >))',
    },
    'replace': {
        r'((self:bytes /\ __old:memoryview + bytes + bytearray /\ __new:memoryview + bytes + bytearray /\ __d___count:SupportsIndex) -> (return:bytes))',
        r'((self:str /\ __old:str /\ __new:str /\ __d___count:SupportsIndex) -> (return:str))',
        r'((self:bytearray /\ __old:memoryview + bytes + bytearray /\ __new:memoryview + bytes + bytearray /\ __d___count:SupportsIndex) -> (return:bytearray))',
    },
    'rfind': {
        r'((self:str /\ __sub:str /\ __d___start:NoneType + SupportsIndex /\ __d___end:NoneType + SupportsIndex) -> (return:int))',
        r'((self:bytes /\ __sub:SupportsIndex + memoryview + bytes + bytearray /\ __d___start:NoneType + SupportsIndex /\ __d___end:NoneType + SupportsIndex) -> (return:int))',
    ...
    'startswith': {
        r'((self:bytes /\ __prefix:tuple < memoryview + bytes + bytearray > + memoryview + bytes + bytearray /\ __d___start:NoneType + SupportsIndex /\ __d___end:NoneType + SupportsIndex) -> (return:bool))',
        r'((self:bytearray /\ __prefix:tuple < memoryview + bytes + bytearray > + memoryview + bytes + bytearray /\ __d___start:NoneType + SupportsIndex /\ __d___end:NoneType + SupportsIndex) -> (return:bool))',
        r'((self:str /\ __prefix:tuple < str > + str /\ __d___start:NoneType + SupportsIndex /\ __d___end:NoneType + SupportsIndex) -> (return:bool))',
    },
    'strip': {
        r'((self:str /\ __d___chars:str + NoneType) -> (return:str))',
        r'((self:bytes /\ __d___bytes:bytearray + memoryview + NoneType + bytes) -> (return:bytes))',
    ...
    'maketrans': {
        ...
        r'((__x:dict < int, T?0 > + dict < str, T?0 > + dict < int + str, T?0 >) -> (return:dict < int, T?0 >))',
        r'((__frm:memoryview + bytes + bytearray /\ __to:memoryview + bytes + bytearray) -> (return:bytes))',
        r'((__x:str /\ __y:str) -> (return:dict < int, int >))',
    },
    '__contains__': {
        r'((self:bytearray /\ __key:bytearray + memoryview + bytes + SupportsIndex) -> (return:bool))',
        r'((self:bytes /\ __key:bytearray + memoryview + bytes + SupportsIndex) -> (return:bool))',
    ...
    'append': {
        r'((self:list < T?0 > /\ __object:T?1) -> (self:list < T?0 + T?1 > /\ return:NoneType))',
    ...
    'obj': {
        r'((self:memoryview < int >) -> (return:memoryview + bytes + bytearray))',
    },
    'c_contiguous': {
        r'((self:memoryview < int >) -> (return:bool))',
    },
    ...
    'subscriptassign': {
        r'((x:tuple < T?0 > /\ y:T?1) -> (x:tuple < T?0 + T?1 > /\ return:NoneType))',
        r'((x:dict < T?0, T?1 > /\ y:T?2) -> (x:dict < T?0, T?2 + T?1 > /\ return:NoneType))',
        r'((x:frozenset < T?0 > /\ y:T?1) -> (x:frozenset < T?0 + T?1 > /\ return:NoneType))',
        r'((x:list < T?0 > /\ y:T?1) -> (x:list < T?0 + T?1 > /\ return:NoneType))',
        r'((x:set < T?0 > /\ y:T?1) -> (x:set < T?0 + T?1 > /\ return:NoneType))',
    },
    'assign_1_prim': {
        r'((c:tuple < T?0 + T?1 > + str) -> (return:tuple < T?0 + T?1 + str >))',
    },
    'for_parse': {
